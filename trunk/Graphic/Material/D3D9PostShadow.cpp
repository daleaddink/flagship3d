...
namespace Flagship
{
	...
	bool    D3D9PostShadow::Initialize()
	{
		// 创建Effect对象
		wchar_t szPath[MAX_PATH];
		GetCurrentDirectory( MAX_PATH, szPath );
		wstring szEffectPath = szPath;
		szEffectPath += L"\\Effect\\D3D9PostShadow.fx";
	...
	void    D3D9PostShadow::BuildParamMap()
	{
	...
	void    D3D9PostShadow::Update( Renderable * pParent )
	{
