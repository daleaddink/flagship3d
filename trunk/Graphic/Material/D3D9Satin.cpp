...
#include "../Renderer/D3D9VolumeTexture.h"
...
namespace Flagship
{
	...
	bool    D3D9Satin::Initialize()
	{
		// 创建D3D9Effect对象
		wchar_t szPath[MAX_PATH];
		GetCurrentDirectory( MAX_PATH, szPath );
		wstring szEffectPath = szPath;
		szEffectPath += L"\\Effect\\D3D9Satin.fx";
		...
		D3D9VolumeTextureHandle hTextureHandle;
	...
	void    D3D9Satin::Update( Renderable * pParent )
	{
	...
	void    D3D9Satin::Update( Resource * pParent )
	{
		Material::Update( pParent );
	}

	bool    D3D9Satin::IsReady()
	{
		if ( ! Material::IsReady() )
		{
			return false;
